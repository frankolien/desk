...
public enum DeskType {
    ...
    public static let display = Font.system(size: 56, weight: .semibold).monospacedDigit()
    /// A secondary figure, still a value that can change.
    public static let figure = Font.system(size: 28, weight: .semibold).monospacedDigit()
    /// Rows of consequence inside a sheet.
    public static let value = Font.system(size: 17, weight: .medium).monospacedDigit()
